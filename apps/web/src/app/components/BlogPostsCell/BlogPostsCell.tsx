...
import type { BlogPostsQuery, BlogPostsQueryVariables } from "@/app/graphql/types";
...
export const Failure = ({ error }: CellFailureProps<BlogPostsQueryVariables>) => (
...
export default createCell<BlogPostsQuery, BlogPostsQueryVariables>({
  QUERY,
  Loading,
  Empty,
  Failure,
